//
//  UIViewController+HPanModalPresenter.swift
//  PanModal
//
...
//
     ...
     */
    extension UIViewController: HPanModalPresenter {
        ...
        public var isPanModalPresented: Bool {
            return (transitioningDelegate as? HPanModalPresentationDelegate) != nil
        }
        ...
        public func presentPanModal(
            _ viewControllerToPresent: HPanModalPresentable.LayoutType,
            ...
            if UIDevice.current.userInterfaceIdiom == .pad {
                ...
                viewControllerToPresent.popoverPresentationController?.delegate = HPanModalPresentationDelegate.default
            } else {
                viewControllerToPresent.modalPresentationStyle = .custom
                viewControllerToPresent.modalPresentationCapturesStatusBarAppearance = true
                viewControllerToPresent.transitioningDelegate = HPanModalPresentationDelegate.default
            }
