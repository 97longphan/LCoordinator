//
//  HPanModalPresentable+LayoutHelpers.swift
//  PanModal
//
...
//
     ...
     */
    extension HPanModalPresentable where Self: UIViewController {
         ...
         */
        var presentedVC: HPanModalPresentationController? {
            return presentationController as? HPanModalPresentationController
        }
        ...
        var longFormYPos: CGFloat {
            return max(
                topMargin(from: longFormHeight),
                topMargin(from: .maxHeight)
            ) + topOffset
        }
         ...
         */
        func topMargin(from: HPanModalHeight) -> CGFloat {
            switch from {
            case .maxHeight:
                return 0.0
