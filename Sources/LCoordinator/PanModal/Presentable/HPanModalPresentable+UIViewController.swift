//
//  HPanModalPresentable+UIViewController.swift
//  PanModal
//
...
//
    ...
    public extension HPanModalPresentable where Self: UIViewController {
         ...
         */
        typealias LayoutType = UIViewController & HPanModalPresentable
         ...
         */
        func panModalTransition(to state: HPanModalPresentationController.PresentationState) {
        ...
        func panModalAnimate(
            ...
            HPanModalAnimator.animate(animationBlock, config: self, completion)
        }
