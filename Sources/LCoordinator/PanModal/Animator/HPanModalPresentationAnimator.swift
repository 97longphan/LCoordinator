//
//  HPanModalPresentationAnimator.swift
//  PanModal
//
...
//
    ...
    public class HPanModalPresentationAnimator: NSObject {
         ...
         */
        private func panModalLayoutType(from context: UIViewControllerContextTransitioning) -> HPanModalPresentable.LayoutType? {
            switch transitionStyle {
            case .presentation:
                return context.viewController(forKey: .to) as? HPanModalPresentable.LayoutType
            case .dismissal:
                return context.viewController(forKey: .from) as? HPanModalPresentable.LayoutType
            }
        }
    ...
    extension HPanModalPresentationAnimator: UIViewControllerAnimatedTransitioning {
        ...
        public func transitionDuration(using transitionContext: UIViewControllerContextTransitioning?) -> TimeInterval {
            ...
            else { return HPanModalAnimator.Constants.defaultTransitionDuration }
