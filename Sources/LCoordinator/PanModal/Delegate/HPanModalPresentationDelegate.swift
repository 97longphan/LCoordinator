//
//  HPanModalPresentationDelegate.swift
//  PanModal
//
...
//
    ...
    /**
     ...
     ```
     */
    public class HPanModalPresentationDelegate: NSObject {

        /**
         Returns an instance of the delegate, retained for the duration of presentation
         */
        public static var `default`: HPanModalPresentationDelegate = {
            HPanModalPresentationDelegate()
        }()

    }

    extension HPanModalPresentationDelegate: UIViewControllerTransitioningDelegate {
        ...
        public func animationController(
            ...
            return HPanModalPresentationAnimator(transitionStyle: .presentation)
        }
        ...
        public func animationController(forDismissed dismissed: UIViewController) -> UIViewControllerAnimatedTransitioning? {
            return HPanModalPresentationAnimator(transitionStyle: .dismissal)
        }
        ...
        public func presentationController(
            ...
            let controller = HPanModalPresentationController(
    ...
    extension HPanModalPresentationDelegate: UIAdaptivePresentationControllerDelegate, UIPopoverPresentationControllerDelegate {
